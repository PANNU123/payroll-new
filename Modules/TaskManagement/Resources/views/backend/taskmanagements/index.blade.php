                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("taskmanagement::text.name")
                            </th>
                            <th>
                                @lang("taskmanagement::text.slug")
                            </th>
                            <th>
                                @lang("taskmanagement::text.updated_at")
                            </th>
                            <th>
                                @lang("taskmanagement::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("taskmanagement::text.action")
                            </th>
                        </tr>
                    </thead>
