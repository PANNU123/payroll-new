                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("managedepartment::text.name")
                            </th>
                            <th>
                                @lang("managedepartment::text.slug")
                            </th>
                            <th>
                                @lang("managedepartment::text.updated_at")
                            </th>
                            <th>
                                @lang("managedepartment::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("managedepartment::text.action")
                            </th>
                        </tr>
                    </thead>
