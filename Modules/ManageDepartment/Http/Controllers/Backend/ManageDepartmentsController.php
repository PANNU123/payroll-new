...
class ManageDepartmentsController extends BackendBaseController
{
    ...
    public function create()
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_name_singular', 'module_action','users','companies')
        );
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_name_singular', 'module_action', "$module_name_singular",'users','companies')
        );
    }
