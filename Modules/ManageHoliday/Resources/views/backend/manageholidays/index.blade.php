                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("manageholiday::text.name")
                            </th>
                            <th>
                                @lang("manageholiday::text.slug")
                            </th>
                            <th>
                                @lang("manageholiday::text.updated_at")
                            </th>
                            <th>
                                @lang("manageholiday::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("manageholiday::text.action")
                            </th>
                        </tr>
                    </thead>
