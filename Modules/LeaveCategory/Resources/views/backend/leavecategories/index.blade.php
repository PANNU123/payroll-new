                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("leavecategory::text.name")
                            </th>
                            <th>
                                @lang("leavecategory::text.slug")
                            </th>
                            <th>
                                @lang("leavecategory::text.updated_at")
                            </th>
                            <th>
                                @lang("leavecategory::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("leavecategory::text.action")
                            </th>
                        </tr>
                    </thead>
