                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("employeeposting::text.name")
                            </th>
                            <th>
                                @lang("employeeposting::text.slug")
                            </th>
                            <th>
                                @lang("employeeposting::text.updated_at")
                            </th>
                            <th>
                                @lang("employeeposting::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("employeeposting::text.action")
                            </th>
                        </tr>
                    </thead>
