                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("managezksetting::text.name")
                            </th>
                            <th>
                                @lang("managezksetting::text.slug")
                            </th>
                            <th>
                                @lang("managezksetting::text.updated_at")
                            </th>
                            <th>
                                @lang("managezksetting::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("managezksetting::text.action")
                            </th>
                        </tr>
                    </thead>
