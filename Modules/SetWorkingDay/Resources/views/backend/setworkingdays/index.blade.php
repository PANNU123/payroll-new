                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("setworkingday::text.name")
                            </th>
                            <th>
                                @lang("setworkingday::text.slug")
                            </th>
                            <th>
                                @lang("setworkingday::text.updated_at")
                            </th>
                            <th>
                                @lang("setworkingday::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("setworkingday::text.action")
                            </th>
                        </tr>
                    </thead>
