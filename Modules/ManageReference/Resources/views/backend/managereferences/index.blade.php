                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("managereference::text.name")
                            </th>
                            <th>
                                @lang("managereference::text.slug")
                            </th>
                            <th>
                                @lang("managereference::text.updated_at")
                            </th>
                            <th>
                                @lang("managereference::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("managereference::text.action")
                            </th>
                        </tr>
                    </thead>
