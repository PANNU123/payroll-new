                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("managedesignation::text.name")
                            </th>
                            <th>
                                @lang("managedesignation::text.slug")
                            </th>
                            <th>
                                @lang("managedesignation::text.updated_at")
                            </th>
                            <th>
                                @lang("managedesignation::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("managedesignation::text.action")
                            </th>
                        </tr>
                    </thead>
