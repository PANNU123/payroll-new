...
namespace Modules\Title\Http\Controllers\Backend;
...
class TitlesController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Titles';

        // module name
        $this->module_name = 'titles';

        // directory path of the module
        $this->module_path = 'title::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\Title\Models\Title";
    }
