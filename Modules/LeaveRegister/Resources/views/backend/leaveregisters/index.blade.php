                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("leaveregister::text.name")
                            </th>
                            <th>
                                @lang("leaveregister::text.slug")
                            </th>
                            <th>
                                @lang("leaveregister::text.updated_at")
                            </th>
                            <th>
                                @lang("leaveregister::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("leaveregister::text.action")
                            </th>
                        </tr>
                    </thead>
