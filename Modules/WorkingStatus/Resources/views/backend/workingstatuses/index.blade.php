                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("workingstatus::text.name")
                            </th>
                            <th>
                                @lang("workingstatus::text.slug")
                            </th>
                            <th>
                                @lang("workingstatus::text.updated_at")
                            </th>
                            <th>
                                @lang("workingstatus::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("workingstatus::text.action")
                            </th>
                        </tr>
                    </thead>
