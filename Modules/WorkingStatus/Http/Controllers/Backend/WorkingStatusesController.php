...
namespace Modules\WorkingStatus\Http\Controllers\Backend;
...
class WorkingStatusesController extends BackendBaseController
{
    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'WorkingStatuses';

        // module name
        $this->module_name = 'workingstatuses';

        // directory path of the module
        $this->module_path = 'workingstatus::backend';

        // module icon
        $this->module_icon = 'fa-regular fa-sun';

        // module model name, path
        $this->module_model = "Modules\WorkingStatus\Models\WorkingStatus";
    }
